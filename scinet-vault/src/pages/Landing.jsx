    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-8 lg:px-12 py-16 md:py-24 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-semibold tracking-tight">
          <span className="bg-gradient-to-r from-primary via-accent to-violet bg-clip-text text-transparent">The trust layer</span> for open research.
        </h1>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 text-left">
          {[
            [3200, '+', 'Verified Papers'],
            [1150, '+', 'Datasets'],
            [12, '', 'Active DAOs'],
            [0.02, '', 'Avg Gas (USD)'],
          ].map(([num, suffix, label], idx) => (
            <TiltCard key={label} className="card-surface p-4">
